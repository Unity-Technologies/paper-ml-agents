...
import pytest
import mapoca.trainers.tests.mock_brain as mb
...
from mapoca.trainers.tests.test_buffer import construct_fake_buffer
from mapoca.trainers.agent_processor import AgentManagerQueue
from mapoca.trainers.settings import TrainerSettings
from mapoca.trainers.tests.dummy_config import create_observation_specs_with_shapes
...
@mock.patch("mapoca.trainers.trainer.trainer.Trainer.save_model")
...
@mock.patch("mapoca.trainers.trainer.trainer.StatsReporter.write_stats")
@mock.patch(
    "mapoca.trainers.trainer.rl_trainer.ModelCheckpointManager.add_checkpoint"
)
...
class RLTrainerWarningTest(unittest.TestCase):
    def test_warning_group_reward(self):
        with self.assertLogs("mapoca.trainers", level="WARN") as cm:
