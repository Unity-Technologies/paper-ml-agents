...
import os
from mapoca.trainers.torch.components.reward_providers import (
    GAILRewardProvider,
    create_reward_provider,
)
from mlagents_envs.base_env import BehaviorSpec, ActionSpec
from mapoca.trainers.settings import GAILSettings, RewardSignalType
from mapoca.trainers.tests.torch.test_reward_providers.utils import (
    create_agent_buffer,
)
from mapoca.trainers.torch.components.reward_providers.gail_reward_provider import (
...
@patch(
    "mapoca.trainers.torch.components.reward_providers.gail_reward_provider.demo_to_buffer"
)
