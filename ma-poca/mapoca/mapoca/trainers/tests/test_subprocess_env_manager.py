...
from mapoca.trainers.subprocess_env_manager import (
    SubprocessEnvManager,
    EnvironmentResponse,
    StepResponse,
    EnvironmentCommand,
)
from mapoca.trainers.env_manager import EnvironmentStep
from mlagents_envs.base_env import BaseEnv
from mlagents_envs.side_channel.stats_side_channel import StatsAggregationMethod
from mlagents_envs.exception import UnityEnvironmentException
from mapoca.trainers.tests.simple_test_envs import (
    SimpleEnvironment,
...
from mapoca.trainers.tests.check_env_trains import (
    check_environment_trains,
    DebugWriter,
)
from mapoca.trainers.tests.dummy_config import ppo_dummy_config
...
class SubprocessEnvManagerTest(unittest.TestCase):
    @mock.patch(
        "mapoca.trainers.subprocess_env_manager.SubprocessEnvManager.create_worker"
    )
    ...
    @mock.patch("mapoca.trainers.subprocess_env_manager.SubprocessEnvManager._step")
    @mock.patch(
        "mapoca.trainers.subprocess_env_manager.SubprocessEnvManager.training_behaviors",
