...
from mapoca.trainers import learn
from mapoca.trainers.trainer_controller import TrainerController
from mapoca.trainers.learn import parse_command_line
from mapoca.trainers.cli_utils import DetectDefault
...
@patch("mapoca.trainers.learn.write_timing_tree")
@patch("mapoca.trainers.learn.write_run_options")
@patch("mapoca.trainers.learn.validate_existing_directories")
@patch("mapoca.trainers.learn.TrainerFactory")
@patch("mapoca.trainers.learn.SubprocessEnvManager")
@patch("mapoca.trainers.learn.create_environment_factory")
@patch("mapoca.trainers.settings.load_config")
