...
from mapoca.trainers.stats import (
    StatsReporter,
    TensorboardWriter,
    StatsSummary,
    GaugeWriter,
...
from mapoca.trainers.env_manager import AgentManager
...
@mock.patch("mapoca.trainers.stats.SummaryWriter")
...
class ConsoleWriterTest(unittest.TestCase):
    def test_console_writer(self):
        # Test write_stats
        with self.assertLogs("mapoca.trainers", level="INFO") as cm:
            category = "category1"
